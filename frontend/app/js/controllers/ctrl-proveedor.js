var app = angular.module('myapp', ['ngPagination']);
	app.controller('ctrlpaginado', function($scope){
		...
		tlf: '+58 0414-8897458',
		direccion: 'una casa, al lado de una referencia zona tal urb tal',
		email: 'uncorreo@gmail.com'
	}, {
		ci: 'V-20.153.333',
		nombre_apellido: 'Juana Magallanes',
		tlf: '+58 0414-8897458',
		direccion: 'una casa, al lado de una referencia zona tal urb tal',
		email: 'uncorreo@gmail.com'
	}, {
		ci: 'V-20.153.333',
		nombre_apellido: 'Joao Da Silva',
		tlf: '+58 0414-8897458',
		direccion: 'una casa, al lado de una referencia zona tal urb tal',
		email: 'uncorreo@gmail.com'
	}, {
		...
		ci: 'V-20.153.333',
		nombre_apellido: 'Maria Clavento',
		tlf: '+58 0414-8897458',
		direccion: 'una casa, al lado de una referencia zona tal urb tal',
		email: 'uncorreo@gmail.com'
	}, {
		...
		ci: 'V-20.153.333',
		nombre_apellido: 'Luis Fonsi',
		tlf: '+58 0414-8897458',
		direccion: 'una casa, al lado de una referencia zona tal urb tal',
		email: 'uncorreo@gmail.com'
	}, {
		ci: 'V-20.153.333',
		nombre_apellido: 'Juan Andrade',
		tlf: '+58 0414-8897458',
		direccion: 'una casa, al lado de una referencia zona tal urb tal',
		email: 'uncorreo@gmail.com'
	}, {
		ci: 'V-20.153.333',
		nombre_apellido: 'Miguel Roman',
		tlf: '+58 0414-8897458',
		direccion: 'una casa, al lado de una referencia zona tal urb tal',
		email: 'uncorreo@gmail.com'
	}, {
		ci: 'V-20.153.333',
		nombre_apellido: 'Teresa Gomez',
		tlf: '+58 0414-8897458',
		direccion: 'una casa, al lado de una referencia zona tal urb tal',
		email: 'uncorreo@gmail.com'
	}, {
		...
		ci: 'E-20.153.333',
		nombre_apellido: 'Manuel Andrade',
		tlf: '+58 0414-8897458',
		direccion: 'una casa, al lado de una referencia zona tal urb tal',
		email: 'uncorreo@gmail.com'
	}, {
		ci: 'V-20.153.333',
		nombre_apellido: 'Nelson Muñoz',
		tlf: '+58 0414-8897458',
		direccion: 'una casa, al lado de una referencia zona tal urb tal',
		email: 'uncorreo@gmail.com'
	}, {
		ci: 'V-20.153.333',
		nombre_apellido: 'Tirso Garcia',
		tlf: '+58 0414-8897458',
		direccion: 'una casa, al lado de una referencia zona tal urb tal',
		email: 'uncorreo@gmail.com'
	}, {
		...
		return {
			...
			link: function(scope, element, attrs) {
				...
				element.bind('blur keyup change', function() {
					scope.personas[attrs.row][attrs.field] = element.text();
				});
